      ...
      <div className="flex flex-col mt-7 w-full text-white max-md:mt-0 max-md:max-w-full">
        {pillarsData.map((pillar, index) => (
          <Pillar
            ...
            {...pillar}
            additionalClasses={
              index === 0 ? "mt-10" : "mt-52 max-lg:mt-32 max-md:mt-20"
            } // Adjust first vs. other Pillars
          />
        ))}
      </div>
    </div>
